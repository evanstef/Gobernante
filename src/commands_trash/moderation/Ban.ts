...
export default class Ban extends Command {
  constructor(client: CustomClient) {
    super(client, {
      name: "ban",
      description:
        "Ban user dari server atau hilangkan ban dari user tersebut.",
      ...
      options: [
        {
          ...
          options: [
            ...
            },
            {
              name: "silent",
              description:
                "Ban user secara silent (tanpa notifikasi ke user tersebut).",
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              name: "silent",
              description:
                "Hilangkan ban user secara silent (tanpa notifikasi ke user tersebut).",
              type: ApplicationCommandOptionType.Boolean,
              required: false,
            },
          ],
