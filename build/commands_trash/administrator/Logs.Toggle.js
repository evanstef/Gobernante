    ...
    async Execute(interaction, args) {
        ...
        try {
            ...
            const embed = new EmbedBuilder()
                .setTitle("✅ Berhasil!")
                .setDescription(`${value ? "Mengaktifkan" : "Menonaktif"} logs tipe **${type}**.`)
                .setColor("Green")
                .setTimestamp();
            ...
            const embed = new EmbedBuilder()
                .setTitle("❌ Gagal!")
                .setDescription(`Gagal ${value ? "Mengaktifkan" : "Menonaktif"} logs tipe **${type}**.`)
                .setColor("Red")
                .setTimestamp();
            await interaction.editReply({
                embeds: [embed],
...
//# sourceMappingURL=Logs.Toggle.js.map